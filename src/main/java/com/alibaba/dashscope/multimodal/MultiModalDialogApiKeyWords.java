...
public class MultiModalDialogApiKeyWords {
  ...
  public static String CONST_NAME_DOWN_STREAM_DEBUG = "debug";
  ...
  public static String CONST_NAME_DOWN_STREAM_VOLUME = "volume";
  ...
  public static String CONST_NAME_DIALOG_ATTRIBUTES_PROMPT = "prompt";
