...
@Slf4j
public class TestTranslationRecognizer {
  ...
  @Test
  public void testRealtimeTask() throws InterruptedException {
    System.out.println("############ Start Test TranslationRecognizerRealtime Call ############");
    ...
    System.out.println("############ Start Test TranslationRecognizerRealtime Done ############");
  }
}
